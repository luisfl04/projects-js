    ...
    navigator.getBattery().then( (batt) => {
        ...
        updateBattery = () => {
            ...
            if (level <= 20) {
                ...
                batteryLiquid.classList.remove("gradient-color-green", "gradient-color-red", "gradient-color-yeloow");
            }
            else if (level <= 79) {
                batteryLiquid.classList.add("gradient-color-yellow");
                batteryLiquid.classList.remove("gradient-color-red", "gradient-color-green", "gradient-color- orange");
            }
            else {
